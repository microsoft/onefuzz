...
* Agent/Supervisor/Proxy: Rename the agent process that runs on the VM from `onefuzz-agent` to `onefuzz_task`. [#1980](https://github.com/microsoft/onefuzz/pull/1980)
