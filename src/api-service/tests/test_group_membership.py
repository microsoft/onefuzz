...
from __app__.onefuzzlib.azure.group_membership import GroupMembershipChecker, StaticGroupMembership
...
class TestRequestAccess(unittest.TestCase):
    ...
    def test_matching_user_id(self) -> None:
        ...
        checker:GroupMembershipChecker = StaticGroupMembership({str(user_id1): [group_id] })
    ...
    def test_user_in_group(self) -> None:
        ...
        user_id = uuid.uuid4()
        checker:GroupMembershipChecker = StaticGroupMembership({str(user_id): [group_id1] })
