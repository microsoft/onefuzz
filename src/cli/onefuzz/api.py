...
class Pool(Endpoint):
    ...
    def create_autoscale(
        ...
        *,
        arch: enums.Architecture = enums.Architecture.x86_64,
        min_size: int = models.AutoScaleConfig.__fields__["min_size"].default,
        max_size: int = models.AutoScaleConfig.__fields__["max_size"].default,
        extra_available_size: Optional[int] = None,
        ...
        return self.create(
            ...
            autoscale=models.AutoScaleConfig(
                ...
                max_size=max_size,
                min_size=min_size,
                extra_available_size=extra_available_size,
                region=region,
