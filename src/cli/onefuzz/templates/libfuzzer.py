...
class Libfuzzer(Command):
    ...
    def basic(
        ...
        *,
        ...
        extra_synced_container: Optional[Container] = None,
        ...
        if extra_synced_container is not None:
            containers[ContainerType.extra_synced] = extra_synced_container
