...
use windows::Win32::{
    ...
    System::SystemServices::{
        FAST_FAIL_APCS_DISABLED, FAST_FAIL_CERTIFICATION_FAILURE, FAST_FAIL_CORRUPT_LIST_ENTRY,
        FAST_FAIL_CRYPTO_LIBRARY, FAST_FAIL_DEPRECATED_SERVICE_INVOKED,
        ...
        FAST_FAIL_GUARD_ICALL_CHECK_SUPPRESSED, FAST_FAIL_GUARD_JUMPTABLE,
        FAST_FAIL_GUARD_SS_FAILURE, FAST_FAIL_GUARD_WRITE_CHECK_FAILURE, FAST_FAIL_INCORRECT_STACK,
        FAST_FAIL_INVALID_ARG, FAST_FAIL_INVALID_BALANCED_TREE, FAST_FAIL_INVALID_BUFFER_ACCESS,
        ...
        FAST_FAIL_INVALID_FIBER_SWITCH, FAST_FAIL_INVALID_FILE_OPERATION,
        FAST_FAIL_INVALID_IDLE_STATE, FAST_FAIL_INVALID_IMAGE_BASE, FAST_FAIL_INVALID_JUMP_BUFFER,
        FAST_FAIL_INVALID_LOCK_STATE, FAST_FAIL_INVALID_LONGJUMP_TARGET,
        FAST_FAIL_INVALID_NEXT_THREAD, FAST_FAIL_INVALID_REFERENCE_COUNT,
        FAST_FAIL_INVALID_SET_OF_CONTEXT, FAST_FAIL_INVALID_SYSCALL_NUMBER,
        FAST_FAIL_INVALID_THREAD, FAST_FAIL_LEGACY_GS_VIOLATION,
        FAST_FAIL_LOADER_CONTINUITY_FAILURE, FAST_FAIL_LPAC_ACCESS_DENIED,
        FAST_FAIL_MRDATA_MODIFIED, FAST_FAIL_MRDATA_PROTECTION_FAILURE,
        FAST_FAIL_RANGE_CHECK_FAILURE, FAST_FAIL_SET_CONTEXT_DENIED,
        FAST_FAIL_STACK_COOKIE_CHECK_FAILURE, FAST_FAIL_UNEXPECTED_HEAP_EXCEPTION,
        FAST_FAIL_UNSAFE_EXTENSION_CALL, FAST_FAIL_UNSAFE_REGISTRY_ACCESS,
...
// See https://docs.microsoft.com/en-us/cpp/intrinsics/fastfail?view=vs-2017 for __fastfail details.
pub const EXCEPTION_FAIL_FAST: NTSTATUS = NTSTATUS(0xC0000409_u32 as i32);
