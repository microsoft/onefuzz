...
# RUSTSEC-2021-0065: a dependency anyhow is no longer supported
cargo audit --deny warnings --deny unmaintained --deny unsound --deny yanked --ignore RUSTSEC-2020-0016
