...
""";
        ...
        Assert.Equal("test", reportInstance?.ExtensionData?["extra_porperty1"].GetString());
        Assert.Equal(5, reportInstance?.ExtensionData?["extra_porperty2"].GetInt32());
