...
//     public WebhookMessageLogOperations(IStorage storage, IQueue queue, ILogTracer log, IWebhookOperations webhook, IServiceConfig config) : base(storage, log, config)
//     {
//         _queue = queue;
//         _log = log;
//         _webhook = webhook;
